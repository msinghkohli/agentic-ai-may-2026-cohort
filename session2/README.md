...
The deep research project implements orchestration pattern with multiple agents to perform deep research on the requested topic. Your assignment is to run the project and observe behaviour using Langfuse traces.
